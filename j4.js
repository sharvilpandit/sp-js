...
sing('Let It Go', () => {
    ...
    const sentence='Hey there, Am I talking with Stack Sum';
    const words=sentence.split(); //converts into a single array
    console.log(words);
    const total=words.reduce((acc,value)=> acc+words.length,0); //counts words of a sentence
